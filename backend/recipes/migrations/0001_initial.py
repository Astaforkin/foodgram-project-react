# Generated by Django 3.2.3 on 2023-08-16 21:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.PositiveIntegerField(verbose_name='Количество ингредиента в рецепте')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(max_length=7, unique=True, validators=[recipes.models.validate_color], verbose_name='Цвет тега')),
        ...
        migrations.AddField(
            model_name='recipe',
            name='tags',
            field=models.ManyToManyField(related_name='recipes', to='recipes.Tag', verbose_name='Тег для рецепта'),
        ),
        migrations.AddField(
